...
class MagazCore::AdminServices::User::ChangeUserTest < ActiveSupport::TestCase
  ...
  test "should not update user with blank params" do
    ...
    assert_equal "Permissions is not a valid array", service.errors.full_messages.last
  end
  ...
  test "should not update user with existing email" do
    ...
    assert_equal "Email is not valid or already has been taken", service.errors.full_messages.first
  end
