...
class MagazCore::ShopServices::Article::AddArticleTest < ActiveSupport::TestCase
  ...
  test 'should create article with valid params' do
    service = MagazCore::ShopServices::Article::AddArticle.run(@success_params)
  ...
  test 'should not create article with same params' do
    ...
    service2 = MagazCore::ShopServices::Article::AddArticle.run(@success_params)
  ...
  test 'should not create article with blank params' do
    service = MagazCore::ShopServices::Article::AddArticle.run(@blank_params)
