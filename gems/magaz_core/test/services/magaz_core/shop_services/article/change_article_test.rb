...
module MagazCore
  class ShopServices::Article::ChangeArticleTest < ActiveSupport::TestCase
    ...
    test 'should update article with valid params' do
      service = MagazCore::ShopServices::Article::ChangeArticle.run(@success_params)
    ...
    test 'should not update article with blank_params' do
      service = MagazCore::ShopServices::Article::ChangeArticle.run(@blank_params)
