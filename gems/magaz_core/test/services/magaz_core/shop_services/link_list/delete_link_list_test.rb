...
class MagazCore::ShopServices::LinkList::DeleteLinkListTest < ActiveSupport::TestCase
  ...
  test 'should delete link list with valid id' do
    service = MagazCore::ShopServices::LinkList::DeleteLinkList.run(id: @link_list.id)
    assert service.valid?
    assert_equal 0, MagazCore::LinkList.count
  end

  test 'should not delete link list with blank id' do
    service = MagazCore::ShopServices::LinkList::DeleteLinkList.run(id: '')
