...
module MagazCore
  class ShopServices::AddLinkListTest < ActiveSupport::TestCase
    ...
    test 'should create link_list with valid params' do
      service = MagazCore::ShopServices::AddLinkList.run(@success_params)
    ...
    test 'should not create link_list with same params' do
      ...
      service2 = MagazCore::ShopServices::AddLinkList.run(@success_params)
    ...
    test 'should not create link_list with blank params' do
      service = MagazCore::ShopServices::AddLinkList.run(@blank_params)
