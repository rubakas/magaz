...
class MagazCore::ShopServices::Shop::CreateTest < ActiveSupport::TestCase
  setup do
  ...
  test 'create shop with valid params' do
    service = MagazCore::ShopServices::Shop::Create.run(@success_params)
  ...
  test 'fail shop creation when no user params' do
    service = MagazCore::ShopServices::Shop::Create.run(shop_name: 'example42', first_name: '' ,
                                                  last_name: '', email: '',
                                                  password: '')
    refute service.valid?
  end
  ...
  test 'fail shop creation when no shop params' do
    service = MagazCore::ShopServices::Shop::Create.run(shop_name: '', first_name: 'First' ,
                                                  last_name: 'Last', email: 'email@mail.com',
                                                  password: 'password')
    refute service.valid?
  end
