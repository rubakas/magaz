...
class MagazCore::ShopServices::Comment::DeleteCommentTest < ActiveSupport::TestCase
  ...
  test 'should delete comment with valid id' do
    ...
    service = MagazCore::ShopServices::Comment::DeleteComment.run(id: @article.id)
  ...
  test 'should not delete comment with blank id' do
    assert_equal 2, @article.comments.count
    service = MagazCore::ShopServices::Comment::DeleteComment.run(id: "")
