...
class MagazCore::ShopServices::Comment::ChangeCommentTest < ActiveSupport::TestCase
  ...
  test 'should update comment with valid params' do
    service = MagazCore::ShopServices::Comment::ChangeComment.run(@success_params)
  ...
  test 'should not update comment with blank params' do
    service = MagazCore::ShopServices::Comment::ChangeComment.run(@blank_params)
