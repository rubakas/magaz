...
class MagazCore::ShopServices::Comment::AddCommentTest < ActiveSupport::TestCase
  ...
  test 'should create comment with valid params' do
    service = MagazCore::ShopServices::Comment::AddComment.run(@success_params)
  ...
  test 'should not create comment for article that belongs to another blog' do
    service = MagazCore::ShopServices::Comment::AddComment.run(@invalid_param)
  ...
  test 'should not create comment with blank params' do
    service = MagazCore::ShopServices::Comment::AddComment.run(@blank_params)
    refute service.valid?
