...
class MagazCore::ShopServices::Blog::AddBlogTest < ActiveSupport::TestCase
  ...
  test 'should create blog with valid params' do
    ...
    service = MagazCore::ShopServices::Blog::AddBlog.run(@success_params)
  ...
  test 'should not create blog with same params' do
    ...
    service2 = MagazCore::ShopServices::Blog::AddBlog.run(@success_params)
  ...
  test 'should not create blog with blank params' do
    assert_equal 1, @shop.blogs.count
    service = MagazCore::ShopServices::Blog::AddBlog.run(@blank_params)
