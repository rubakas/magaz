...
class MagazCore::ShopServices::Page::AddPageTest < ActiveSupport::TestCase
  ...
  test 'should create page with valid params' do
    ...
    service = MagazCore::ShopServices::Page::AddPage.run(@success_params)
  ...
  test 'should not create page with same params' do
    ...
    service2 = MagazCore::ShopServices::Page::AddPage.run(@success_params)
  ...
  test 'should not create page with blank params' do
    assert_equal 1, @shop.pages.count
    service = MagazCore::ShopServices::Page::AddPage.run(@blank_params)
