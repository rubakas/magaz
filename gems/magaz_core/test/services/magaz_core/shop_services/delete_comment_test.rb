...
module MagazCore
  class ShopServices::DeleteCommentTest < ActiveSupport::TestCase
    ...
    test 'should delete comment with valid id' do
      ...
      service = MagazCore::ShopServices::DeleteComment.run(id: @article.id)
    ...
    test 'should not delete comment with blank id' do
      assert_equal 2, @article.comments.count
      service = MagazCore::ShopServices::DeleteComment.run(id: "")
