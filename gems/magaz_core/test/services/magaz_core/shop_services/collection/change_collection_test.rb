...
class MagazCore::ShopServices::Collection::ChangeCollectionTest < ActiveSupport::TestCase
  ...
  test 'should update collection with valid params' do
    service = MagazCore::ShopServices::Collection::ChangeCollection.run(@success_params)
