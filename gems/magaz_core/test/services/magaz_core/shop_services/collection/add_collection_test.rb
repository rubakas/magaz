...
class MagazCore::ShopServices::Collection::AddCollectionTest < ActiveSupport::TestCase
  ...
  test 'should create collection with valid params' do
    ...
    service = MagazCore::ShopServices::Collection::AddCollection.run(@success_params)
  ...
  test 'should not create collection with same params' do
    ...
    service2 = MagazCore::ShopServices::Collection::AddCollection.run(@success_params)
  ...
  test 'should not create collection with blank params' do
    assert_equal 1, @shop.collections.count
    service = MagazCore::ShopServices::Collection::AddCollection.run(@blank_params)
