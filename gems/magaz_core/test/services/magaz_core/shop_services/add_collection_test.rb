...
module MagazCore
  class ShopServices::AddCollectionTest < ActiveSupport::TestCase
    ...
    test 'should create collection with valid params' do
      ...
      service = MagazCore::ShopServices::AddCollection.run(@success_params)
    ...
    test 'should not create collection with same params' do
      ...
      service2 = MagazCore::ShopServices::AddCollection.run(@success_params)
    ...
    test 'should not create collection with blank params' do
      assert_equal 1, @shop.collections.count
      service = MagazCore::ShopServices::AddCollection.run(@blank_params)
