...
module MagazCore
  class ShopServices::DeleteCheckoutTest < ActiveSupport::TestCase
    ...
    test 'should delete checkout with valid id' do
      ...
      service = MagazCore::ShopServices::DeleteCheckout.run(id: @abandoned_checkout.id)
    ...
    test 'should not checkout blog with blank id' do
      assert_equal 1, @shop.checkouts.count
      service = MagazCore::ShopServices::DeleteCheckout.run(id: "")
