...
module MagazCore
  class ShopServices::ChangeCustomerTest < ActiveSupport::TestCase
    ...
    test 'should update customer with valid params' do
      service = MagazCore::ShopServices::ChangeCustomer.run(@success_params)
    ...
    test 'should not update customer with blank_params' do
      service = MagazCore::ShopServices::ChangeCustomer.run(@blank_params)
