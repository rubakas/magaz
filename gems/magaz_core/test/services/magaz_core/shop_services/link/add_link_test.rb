...
class MagazCore::ShopServices::Link::AddLinkTest < ActiveSupport::TestCase
  ...
  test 'should create link with valid params' do
    service = MagazCore::ShopServices::Link::AddLink.run(@success_params)
  ...
  test 'should not create link with same params' do
    ...
    service2 = MagazCore::ShopServices::Link::AddLink.run(@success_params)
  ...
  test 'should not create link with blank params' do
    service = MagazCore::ShopServices::Link::AddLink.run(@blank_params)
