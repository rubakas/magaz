...
class MagazCore::ShopServices::Customer::AddCustomeromerTest < ActiveSupport::TestCase
  ...
  test 'should create customer with valid params' do
    service = MagazCore::ShopServices::Customer::AddCustomer.run(@success_params)
  ...
  test 'should not create customer with same params' do
    service = MagazCore::ShopServices::Customer::AddCustomer.run(@success_params)
    assert service.valid?
    service2 = MagazCore::ShopServices::Customer::AddCustomer.run(@success_params)
  ...
  test 'should not create customer with blank params' do
    service = MagazCore::ShopServices::Customer::AddCustomer.run(@blank_params)
