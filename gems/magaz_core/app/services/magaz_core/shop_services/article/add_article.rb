class MagazCore::ShopServices::Article::AddArticle < ActiveInteraction::Base
  ...
  def title_uniqueness
    errors.add(:base, I18n.t('default.services.add_article.title_not_unique')) unless title_unique?
  end
