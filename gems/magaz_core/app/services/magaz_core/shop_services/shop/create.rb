class MagazCore::ShopServices::Shop::Create < ActiveInteraction::Base
  ...
  def execute
    ...
    MagazCore::Shop.connection.transaction do
      begin
        ...
        compose(MagazCore::ShopServices::Collection::AddCollection,
                handle: '',
  ...
  def _create_default_blogs_and_posts!(shop_id:)
    default_blog = compose(MagazCore::ShopServices::Blog::AddBlog,
                           meta_description: '',
    ...
    compose(MagazCore::ShopServices::Article::AddArticle,
            handle: '',
  ...
  def _create_default_link_lists!(shop_id:)
    #Main Menu link list
    default_menu_link_list = compose(MagazCore::ShopServices::LinkList::AddLinkList,
                                     shop_id: shop_id,
                                     name: I18n.t('default.models.link_list.menu_link_list_name'),
                                     handle: '')

    #Links for Main Menu
    compose(MagazCore::ShopServices::Link::AddLink,
            position: '',
    ...
    #Footer link list
    default_footer_link_list = compose(MagazCore::ShopServices::LinkList::AddLinkList,
                                       shop_id: shop_id,
