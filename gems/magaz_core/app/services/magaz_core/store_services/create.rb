class MagazCore::StoreServices::Create < ActiveInteraction::Base
  ...
  def execute
    ...
    MagazCore::Shop.connection.transaction do
      begin
        ...
        integrate(MagazCore::AdminServices::Collection::AddCollection,
                  handle: '',
        ...
        integrate(MagazCore::AdminServices::Page::AddPage,
                  shop_id: @shop.id,
  ...
  def _install_default_theme(shop_id:)
    ...
    if MagazCore::Theme.sources.first
      integrate(MagazCore::ThemeServices::InstallTheme,
              shop_id: shop_id,
  ...
  def _create_default_blogs_and_posts!(shop_id:)
    default_blog = integrate(MagazCore::AdminServices::Blog::AddBlog,
                             meta_description: '',
    ...
    integrate(MagazCore::AdminServices::Article::AddArticle,
              handle: '',
  ...
  def _create_default_link_lists!(shop_id:)
    #Main Menu link list
    default_menu_link_list = integrate(MagazCore::AdminServices::LinkList::AddLinkList,
                                       shop_id: shop_id,
                                       name: I18n.t('default.models.link_list.menu_link_list_name'),
                                       handle: '')

    #Links for Main Menu
    integrate(MagazCore::AdminServices::Link::AddLink,
              position: '',
    ...
    #Footer link list
    default_footer_link_list = integrate(MagazCore::AdminServices::LinkList::AddLinkList,
                                         shop_id: shop_id,
