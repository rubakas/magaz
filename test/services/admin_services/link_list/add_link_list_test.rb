...
class AdminServices::LinkList::AddLinkListTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @blank_params =   { name: '', handle: '' }
  end

  test 'should create link_list with valid params' do
    service = AdminServices::LinkList::AddLinkList.new(shop_id: @shop.id, params: @success_params).run
  ...
  test 'should not create link_list with blank params' do
    service = AdminServices::LinkList::AddLinkList.new(shop_id: @shop.id, params: @blank_params).run
